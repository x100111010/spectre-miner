...
mod tests {
    ...
    #[test]
    fn test_heavy_hash_v2() {
        let expected_hash = Hash::from_le_bytes([
            132, 186, 34, 145, 50, 119, 177, 72, 138, 201, 77, 69, 186, 148, 205, 128, 47, 94, 179, 252, 25, 221, 136,
            187, 82, 47, 218, 56, 87, 168, 75, 164,
        ]);
        #[rustfmt::skip]
        let test_matrix = Matrix([
            [13, 2, 14, 13, 2, 15, 14, 3, 10, 4, 1, 8, 4, 3, 8, 15, 15, 15, 15, 15, 2, 11, 15, 15, 15, 1, 7, 12, 12, 4, 2, 0, 6, 1, 14, 10, 12, 14, 15, 8, 10, 12, 0, 5, 13, 3, 14, 10, 10, 6, 12, 11, 11, 7, 6, 6, 10, 2, 2, 4, 11, 12, 0, 5],
        ...
        let result = test_matrix.heavy_hash_v2(hash);
        println!("Heavy hash v2 result: {:?}", result.to_le_bytes());
        assert_eq!(test_matrix.heavy_hash_v2(hash), expected_hash);
    }
